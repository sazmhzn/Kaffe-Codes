...
const Footer = () => {
  return (
    <>
      {/* Footer container */}
      <footer className="bg-black text-center mx-auto text-white lg:text-left">
        ...
        <div className="mx-auto max-w-7xl  py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="gap-10 inline-flex pb-6 border-b mb-2">
                {" "}
                <p className="mb-4 flex items-center justify-center md:justify-start">
                  Monday - Friday
                </p>
              ...
              <div className="px-4 py-2 flex bg-white rounded-full">
                <input type="text" placeholder="Enter your email" />
                <Button className="bg-[#007500] px-2 py-2 text-white rounded-full">
                  Subscribe
                </Button>
              </div>
            </div>
